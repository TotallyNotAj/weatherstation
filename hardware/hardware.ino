...
#define SOIL_DRY_VAL  3200  // Raw ADC value in dry air / dry soil
#define SOIL_WET_VAL  1100  // Raw ADC value in water / saturated soil
...
static void draw_card(Rect r, const char *value, const char *unit) {
  ...
  canvas.setCursor(((area_w - (int16_t)w) / 2) - x1,
                   ((area_h - (int16_t)h) / 2) - y1 - 4);
  canvas.print(value);
